...
let BlogComponent = class BlogComponent {
    constructor(Api, toastrService, router, shared) {
        this.Api = Api;
    ...
    ngOnInit() {
        ...
        //       preloader: false,
        //   });
        this.Api.Read(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_5__["APIENUM"].BLOG).subscribe((res) => {
            this.blog = res.data;
        }, (err) => {
...
let ContactComponent = class ContactComponent {
    ...
    createContact() {
        ...
        let value = Object.assign({ status: 'active' }, this.Contact.value);
        this.Api.Create(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_4__["APIENUM"].User, value).subscribe((res) => {
...
let DashboardComponent = class DashboardComponent {
    constructor(Api, toastrService, Route, shared, _sanitizer) {
        this.Api = Api;
        this.toastrService = toastrService;
        this.Route = Route;
        this.shared = shared;
    ...
    ngOnInit() {
        this.Api.Read(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_4__["APIENUM"].property).subscribe((res) => {
            this.property = res.data;
            var mostRecentDate = new Date(Math.max.apply(null, this.property.map((e) => {
                return new Date(e.registered);
            })));
            var mostRecentObject = this.property.filter((e) => {
        ...
        this.Api.Read(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_4__["APIENUM"].BLOG).subscribe((res) => {
            this.blog = res.data;
        }, (err) => {
            this.toastrService.error(err.error.message);
        });
...
let EmployeeComponent = class EmployeeComponent {
    constructor(Api, toastrService, router, shared, _sanitizer) {
        this.Api = Api;
        this.toastrService = toastrService;
        this.router = router;
        this.shared = shared;
    ...
    ngOnInit() {
        this.Api.Read(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_6__["APIENUM"].property).subscribe((res) => {
            this.property = res.data;
...
let InnerviewComponent = class InnerviewComponent {
    constructor(shared, Api, toastrService, _fb, _sanitizer, router) {
        this.shared = shared;
        this.Api = Api;
        this.toastrService = toastrService;
        this._fb = _fb;
    ...
    ngOnInit() {
        ...
        this.Api.Read(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_5__["APIENUM"].property).subscribe((res) => {
            this.property = res.data;
            var mostRecentDate = new Date(Math.max.apply(null, this.property.map((e) => {
                return new Date(e.registered);
            })));
    ...
    createContact() {
        this.Contact.disable();
        let value = Object.assign({ status: 'active' }, this.Contact.value);
        this.Api.Create(src_app_shared_enum__WEBPACK_IMPORTED_MODULE_5__["APIENUM"].User, value).subscribe((res) => {
            this.success = res.message;
            this.toastrService.success(res.message);
        }, err => {
            this.error = err.error.message;
...
InnerviewComponent.ctorParameters = () => [
    { type: src_app_shared_shared_shared_service__WEBPACK_IMPORTED_MODULE_7__["SharedService"] },
    { type: src_app_shared_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] },
...
let PagesComponent = class PagesComponent {
    constructor(Api, toastrService, _fb, _sanitizer) {
        this.Api = Api;
        this.toastrService = toastrService;
        this._fb = _fb;
        this._sanitizer = _sanitizer;
...
SingleblogComponent.ctorParameters = () => [
...
/* harmony import */ var ngx_masonry__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-masonry */ "./node_modules/ngx-masonry/fesm2015/ngx-masonry.js");
/* harmony import */ var ng_uikit_pro_standard__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ng-uikit-pro-standard */ "./node_modules/ng-uikit-pro-standard/fesm2015/ng-uikit-pro-standard.js");
