...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./enum */ "./src/app/@shared/enum.ts");
...
var ApiService = /** @class */ (function () {
    function ApiService(_http) {
        this._http = _http;
        this.apiUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].url;
    }
    //create
    ApiService.prototype.Create = function (type, data) {
        return this._http.post("" + this.apiUrl + type.toString() + "/create", data);
    };
    //update
    ApiService.prototype.Update = function (type, data) {
        return this._http.post("" + this.apiUrl + type.toString() + "/update", data);
    };
    //readAll
    ApiService.prototype.Read = function (type) {
        return this._http.post("" + this.apiUrl + type.toString() + "/read", {});
    };
    //readOne
    ApiService.prototype.ReadOne = function (type, data) {
        return this._http.post("" + this.apiUrl + type.toString() + "/read_one", data);
    };
    ApiService.prototype.Login = function (type, data) {
        return this._http.post("" + this.apiUrl + type.toString() + "/login", data);
    };
    ApiService.prototype.FileUpload = function (f) {
        var formData = new FormData();
        formData.append('files', f);
        return this._http.post(this.apiUrl + _enum__WEBPACK_IMPORTED_MODULE_2__["APIENUM"].FILE, formData);
    };
...
(function (APIENUM) {
    ...
    APIENUM["BLOG"] = "blog";
    APIENUM["FILE"] = "upload";
    APIENUM["property"] = "property";
})(APIENUM || (APIENUM = {}));


/***/ }),

/***/ "./src/app/@shared/intercept.ts":
/*!**************************************!*\
  !*** ./src/app/@shared/intercept.ts ***!
  \**************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api.service */ "./src/app/@shared/api.service.ts");



var InterceptorServices = /** @class */ (function () {
    function InterceptorServices(shared) {
        this.shared = shared;
    }
    InterceptorServices.prototype.intercept = function (request, next) {
        var idToken = sessionStorage.getItem('jwt');
    ...
    InterceptorServices.ctorParameters = function () { return [
        { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
    ]; };
    InterceptorServices = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
    ], InterceptorServices);
...
/***/ "./src/app/@shared/shared/shared.service.ts":
/*!**************************************************!*\
  !*** ./src/app/@shared/shared/shared.service.ts ***!
  \**************************************************/
...
var SharedService = /** @class */ (function () {
    function SharedService() {
        this._Info = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
    }
    SharedService.prototype.AddInfo = function (info) {
